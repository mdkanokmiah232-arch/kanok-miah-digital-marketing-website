...
export const metadata: Metadata = {
  title: 'Local SEO in the UK',
  description: 'Local SEO in the UK — Kanok Miah provides SEO and digital marketing services tailored to the Uk market.',
};
    ...
    <section className="bg-[var(--color-paper)]">
      <div className="mx-auto max-w-3xl px-4 py-16 lg:px-8">
        <p className="text-sm text-[var(--color-signal-dk)]">
          <Link href="/services" className="hover:underline">Services</Link> / <Link href="/services/local-seo" className="hover:underline">Local Seo</Link> / Uk
        </p>
        ...
        <h1 className="mt-4 font-display text-4xl text-[var(--color-forest)]">Local SEO in the UK</h1>
        <div className="mt-6 rounded-[var(--radius-card)] border border-[var(--color-signal)]/20 bg-[var(--color-signal)]/5 p-6">
          ...
          <p className="mt-2 text-[var(--color-graphite)]">
            Kanok Miah provides local seo services to Uk businesses, with strategies adapted to local search behavior and competition.
          </p>
        </div>
